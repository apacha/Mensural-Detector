...
if __name__ == "__main__":
    ...
    parser.add_argument('-inference_graph', dest='inference_graph', type=str, required=True,    help='Path to the stored inference graph.')    
    ...
    vis_util.visualize_boxes_and_labels_on_image_array(
          ...
          line_thickness=1)
    Image.fromarray(image_np).save(args.output)
