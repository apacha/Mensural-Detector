...
from position_classification.models.DenseNet201PretrainedConfiguration import DenseNet201PretrainedConfiguration
...
from position_classification.models.ResNet50PretrainedConfiguration import ResNet50PretrainedConfiguration
from position_classification.models.TrainingConfiguration import TrainingConfiguration
from position_classification.models.Vgg16PretrainedConfiguration import Vgg16PretrainedConfiguration
...
class ConfigurationFactory:
    ...
    def get_all_configurations(width, height, number_of_classes) -> List[
        ...
        configurations = [Vgg4Configuration(width, height, number_of_classes),
                          ...
                          Vgg16PretrainedConfiguration(width, height, number_of_classes),
                          ResNet50PretrainedConfiguration(width, height, number_of_classes),
                          DenseNet201PretrainedConfiguration(width, height, number_of_classes),
